...
CANTXMessage<2> gps_messaage{can_bus, kGPS_CAN, 8, 50, read_timer, lat_signal, lon_signal};
bool requested_gps = false;
...
void setup()
{
  ...
  // read_timer.AddTimer(10, []()
  //                     { requested_gps = true; });
  read_timer.AddTimer(10, ReadAccel);
  read_timer.AddTimer(10, ReadGyro);
  read_timer.AddTimer(50, ReadGPS);

  // xTaskCreatePinnedToCore([](void *param)
  //                         { ReadGPS(); },
  //                         "GPS read", 4096, NULL, 1, NULL, 0);
  // sampling rate
}
